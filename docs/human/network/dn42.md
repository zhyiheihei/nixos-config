...
`hostdare` is the current external DN42 ingress. Its WireGuard and MP-BGP session
to `sg1.g-load.eu` is defined by the encrypted hidden module and carries both
IPv4 and IPv6 routes.

`greencloud` is the home-side DN42 router and authoritative DNS server.

- IPv4: `172.20.46.225`
- IPv6: `fdd8:1938:4e88:120::1`
