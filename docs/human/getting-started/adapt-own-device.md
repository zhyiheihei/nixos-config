...
[新主机接入规范](../../agent/new-host-standard.md) 和根目录 [`AGENTS.md`](../../../AGENTS.md) 为准。
ARM 开发板还应先阅读
...
加入 WireGuard、ZeroTier 或 DN42 的机器还应按[新主机接入规范](../../agent/new-host-standard.md)
检查握手、路由与 BIRD 状态。完整部署命令见[构建与部署当前主机](../../agent/deployment.md)。
