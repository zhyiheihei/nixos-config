...
入口与完整步骤以 [`../../agent/nixos-reinstallation-guide.md`](../../agent/nixos-reinstallation-guide.md)
...
- [x] `wg show` 7 个 peer handshake（greencloud/volcengine/google/ml-builder/rock5c/
...
- [x] `manualDeploy` 移除，colmena 部署 tencent/volcengine/google/ml-builder/rock5c/
