...
- [nixos-anywhere SSH 远程装 NixOS](./nixos-anywhere.md)
- [disko 声明式磁盘分区](./disko.md)
- [nixvim Nix 配置 Neovim](./nixvim.md)
...
- [nix-ld 运行未 patch 的动态二进制](./nix-ld.md)
- [nixd Nix language server](./nixd.md)
- [nix-init 从 URL 生成包](./nix-init.md)
- [nix-index 按文件查包](./nix-index.md)
- [nixGL OpenGL/Vulkan wrapper](./nixGL.md)
- [naersk 简单 Rust builder](./naersk.md)
- [srvos 服务器 profile](./srvos.md)
- [poetry2nix Poetry 转 Nix（停维护）](./poetry2nix.md)
- [nurl URL 生成 fetcher](./nurl.md)
- [nixos-facter 硬件报告](./nixos-facter.md)
- [nixpkgs-update nixpkgs 自动更新](./nixpkgs-update.md)
- [vscode-nix-ide VSCode Nix 插件](./vscode-nix-ide.md)
- [rnix-parser Rust Nix parser](./rnix-parser.md)
