...
| `attic.zhyi.xin` | CNAME 到 `colocrossing.zhyi.cc` | Attic URL 为 `https://attic.zhyi.xin:8443/lantian`；与 `vaults3.zhyi.cc` 一起使用家庭缓存数据面 |
| `vaults3.zhyi.cc`、`colocrossing.zhyi.cc` | CNAME 到 `home-ddns.zhyi.cc` | 高流量缓存数据面和家庭入口 DDNS |
