...
- vendor r8125 驱动 A/B 已关闭：2026-08-11 17:40 eth0 NETDEV WATCHDOG 复现旧事故（见 [06](./06-router-lan-drop-netdev-watchdog.md)），已回滚 r8169（待部署重启验证）；eth0 的 `10-router-lan.link` 固定 EEPROM MAC 仍保留；2.5G hairpin 吞吐复测未做；“重启变关机”事故未定位。
