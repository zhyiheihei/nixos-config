...
| `macmini` | 115（旧） | `192.168.0.54`（保留地址） | — | `198.18.0.115` | 已退役（2026-09-04）；最后配置归档于同级 `../../host-archive` 仓库。index 115 空出 |
| `ml-home-vm` | 115（旧） | `192.168.0.51`（保留地址） | `c340ae9a91` | `198.18.0.115` | 已退役（2026-08-03）；index 115 曾由 `macmini` 继承（后者 2026-09-04 退役，已空出） |
