...
}:
{
  services.sunshine = {
    ...
    settings = {
      ...
      # Comma-separated because nixpkgs' settings option only accepts atoms.
      csrf_allowed_origins = "https://192.168.0.53:47990,https://198.18.0.113:47990,https://ml-2700.zhyi.cc:47990";
